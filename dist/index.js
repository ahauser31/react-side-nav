(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("ReactSideNav", ["react", "classnames"], factory);
	else if(typeof exports === 'object')
		exports["ReactSideNav"] = factory(require("react"), require("classnames"));
	else
		root["ReactSideNav"] = factory(root["React"], root["classNames"]);
...
var SideNavItem = function SideNavItem(props) {
  ...
  _react2.default.createElement(
    'div',
    {
      className: (0, _classnames2.default)('side-nav-item', 'level-' + props.level, { collapsed: !props.expanded, expanded: props.expanded, active: props.active }),
...
exports.Icon = exports.Chevron = undefined;
...
var Chevron = exports.Chevron = function Chevron(props) {
  return _react2.default.createElement('i', {
    className: (0, _classnames2.default)('fa', props.className, { 'fa-chevron-left': !props.expanded, 'fa-chevron-down': props.expanded })
  });
};
...
var Icon = exports.Icon = function Icon(props) {
  return _react2.default.createElement('i', { className: (0, _classnames2.default)('fa', props.className) });
};
...
var _sideNavItem = __webpack_require__(2);

var _sideNavItem2 = _interopRequireDefault(_sideNavItem);

var _sideNavHelpers = __webpack_require__(7);
...
var SideNav = function (_Component) {
  ...
  function SideNav() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SideNav.__proto__ || Object.getPrototypeOf(SideNav)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      items: [],
      activeItemLink: null
      ...
      return _this.state.items.map(function (item) {
        return _react2.default.createElement(_sideNavItem2.default, _extends({
          key: item.id,
          level: 0,
          linkComponent: _this.props.linkComponent,
          chevronComponent: _this.props.chevronComponent,
      ...
      return _react2.default.createElement(
        'div',
        { className: (0, _classnames2.default)('side-nav', _this.props.className, { 'default-theme': !_this.props.className }) },
        _this.renderItems()
      );
  ...
  _createClass(SideNav, [{
    ...
    value: function componentWillReceiveProps(newProps) {
      if (newProps && newProps.activeItem) {
        var items = (0, _sideNavHelpers.activateItemWithLink)(newProps.activeItem, this.state.items);
        this.setState({ activeItemLink: newProps.activeItem, items: items });
      }
    }
  }]);
...
var createItemTree = exports.createItemTree = function createItemTree(input) {
  var level = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  return input.map(function (item) {
    return item.items ? _extends({ expanded: false, active: false, level: level }, item, { items: createItemTree(item.items, level + 1) }) : _extends({ expanded: false, active: false, level: level }, item);
  });
};

var collapseTree = exports.collapseTree = function collapseTree(items) {
  return items.map(function (item) {
    return item.items ? _extends({}, item, { expanded: false, items: collapseTree(item.items) }) : _extends({}, item, { expanded: false });
  });
};
...
var expandParent = function expandParent(parentItem) {
  return function () {
    parentItem.expanded = true;
  };
}; // eslint-disable-line no-param-reassign

var activateParent = function activateParent(parentItem) {
  return function () {
    parentItem.active = true;
  };
}; // eslint-disable-line no-param-reassign

var switchItem = function switchItem(activate, items, id) {
  var link = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  var switchParentFn = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
  return items.map(function (item) {
    ...
    if (id && newItem.id === id || !id && newItem.link && newItem.link === link) {
      ...
      if (newItem.items) {
        newItem.items = activate ? switchItem(true, newItem.items, id, link, activateParent(newItem)) : switchItem(false, newItem.items, id, link, expandParent(newItem));
      }
...
Object.defineProperty(exports, 'SideNavItem', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_sideNavItem).default;
  }
});

var _sideNavAddons = __webpack_require__(5);

Object.defineProperty(exports, 'Chevron', {
  enumerable: true,
  get: function get() {
    return _sideNavAddons.Chevron;
  }
});
Object.defineProperty(exports, 'Icon', {
  enumerable: true,
  get: function get() {
    return _sideNavAddons.Icon;
  }
});
